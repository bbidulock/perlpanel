...
#
# $Id: PerlPanel.spec,v 1.14 2004/03/19 16:10:22 jodrell Exp $
...
Requires: perl >= 5.8.0, gtk2, libglade2, perl(Gtk2), perl(Gnome2::Wnck), perl(Gtk2::GladeXML), perl(XML::Simple), perl(Xmms::Remote), perl(Locale::gettext)
