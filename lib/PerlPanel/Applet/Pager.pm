# $Id: Pager.pm,v 1.4 2004/02/11 17:04:09 jodrell Exp $
...
sub configure {
	...
	my $x = PerlPanel::icon_size() * (PerlPanel::screen_width() / PerlPanel::screen_height()) * $self->{screen}->get_workspace_count;
	my $y = PerlPanel::icon_size();
