...
=for comment
$Id: perlpanel-applet-howto.pod,v 1.3 2003/06/19 15:59:38 jodrell Exp $
...
display. PerlPanel attempts to work this out if the systems Gtk+ is
recent enough, otherwise it will take them from the user's config file.
