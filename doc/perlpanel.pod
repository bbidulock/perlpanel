...
=for comment
$Id: perlpanel.pod,v 1.7 2003/06/23 12:34:00 jodrell Exp $
...
Screen tab is only visible if the version of Gtk+ (2.2.0 or higher) on
your system does not support for the C<GdkScreen> functions. If it does,
PerlPanel will determine your screen resolution for itself.
