...
=for comment
$Id: perlpanel.pod,v 1.6 2003/06/19 15:57:03 jodrell Exp $
...
The Screen tab contains controls for the display width and height. The
Screen tab is only visible if the version of Gtk+ on your system does
not support for the C<GdkScreen> functions. If it does, PerlPanel will
determine your screen resolution for itself.
